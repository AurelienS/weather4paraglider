...
export const es: Dict = {
  brandSub: "Windgram & sounding por modelo · Open-Meteo multimodelo",
  ...
  hourLabel: "Hora",
  hintLevels: "Rejilla de 250 m interpolada entre los niveles del modelo",
  boardAria: "Panel de comparación",
  compareBack: "Volver al lugar",
  ...
  compareHint: "Apilar varios lugares en una página",
  ...
  guideOpen: "Primeros pasos",
  guideBack: "Volver a la app",
