...
export const de: Dict = {
  ...
  meteoLblCloud: "Wolken",
  meteoLblCbl: "Konvektion",
  meteoLblTd: "Taupunkt",
  meteoLblWind: "Wind",
  meteoLblGust: "Böen",
  hourLabel: "Uhrzeit",
  ...
  soundingUnavailable: "Dieses Modell hat keine Isobarenstufen — Emagramm nicht verfügbar. Wähle ein anderes Modell.",
  pinAlt: "Höhe {m} m",
